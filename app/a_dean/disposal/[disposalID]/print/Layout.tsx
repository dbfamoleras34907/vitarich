...
export default function Layout() {
  ...
  // ✅ Full name
  const fullName =
    `${data[0]?.firstname || ""} ${data[0]?.middlename || ""} ${data[0]?.lastname || ""}`.trim();
      ...
      <div className="max-h-[calc(100vh-13rem)] overflow-y-auto ">
        <div className=" bg-white mx-4 rounded-2xl shadow w-fit">
          <div ref={printRef} className="a4-page">
            ...
            <div className="mt-8">
              <div>
                Transferred the following material and supplies in good
                condition.
              </div>
              ...
              <table>
                <thead className="bg-gray-300">
                  <tr>
                    <th className="whitespace-nowrap border-2 border-black px-4">
                      PROD CODE
                    </th>
                    <th className="whitespace-nowrap border-2 border-black w-full">
                      DESCRIPTION
                    </th>
                    <th className="whitespace-nowrap border-2 border-black px-4">
                      QUANTITY
              ...
              <p className="text-sm">
                NOTE: The authorized courier shall be responsible for any loss
                or damage to the materials and supplies while in transit. Such
                liability shall be extinguished only upon the authorized
                transferee’s acknowledgment of receipt of the materials and
                supplies in the same condition as specified above.
              </p>
              ...
              <div className="grid-cols-2 grid gap-2">
                ...
                <div>
                  <div className="-mt-1">
                    Original - desctribution / transferee
                  </div>
