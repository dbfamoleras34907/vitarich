...
const INSTRUCTIONS = [
  ...
  ['DOC Source', 'Required', 'Enter the DOC source exactly as it should appear.'],
  ['Hatchery', 'Required', 'Select a hatchery farm, or use Free text instead when it is not listed.'],
