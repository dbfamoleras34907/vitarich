-- Combined Clean Up update. Prerequisites: existing Clean Up schema and current notification_system.sql.
-- Generated from allow_harvest_emptied_cleanup.sql and save_br_cleanup_transaction.sql.
-- Apply reverse_br_cleanup_transaction.sql afterward to enable reversal.
-- Run this entire file in the SQL Editor of the Supabase project used by the app.
begin;


-- Source: app/brd/cu/allow_harvest_emptied_cleanup.sql
...
-- Source: app/brd/cu/save_br_cleanup_transaction.sql
