...
const mod = { exports: {} }
new Function('require', 'module', 'exports', code)(() => ({ db: {} }), mod, mod.exports)
...
const card = { id: 5, farm_id: 65, building_whse_id: 134, building_code: 'BD-0000021', card_no: 'FLOCK-1',
  cycle_no: '1', farm_cycle_id: 9, doc_farm_cycles: { cycle_no: 7 }, flock_card_origin: [], extra: null }
...
assert.equal(formatBroilerCycleNumbers(resolved()), '1', 'same cycle number used by Growing')
...
assert.equal(formatBroilerCycleNumbers({ cycleNumber: '1' }), '1')
