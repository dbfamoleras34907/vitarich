    ...
    <div className="relative w-full">
      ...
      <div className="relative">
        <input
          ...
          className={cn(
            "field-sizing-content file:text-foreground placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground flex h-10 w-full min-w-0 rounded-md border border-[#b8b2aa] bg-white px-3 py-2 text-base shadow-none transition-[color,box-shadow,border-color] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:bg-gray-100 disabled:text-muted-foreground disabled:opacity-100 md:text-sm dark:border-input dark:bg-input/30 dark:disabled:bg-input/20",
